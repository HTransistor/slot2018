...
\subcaption[c]{Filterrad und PMT}
\end{subfigure}

\caption{Die Laserkonfiguration ist vom restlichen Versuchsaufbau getrennt \cite{Anleitung}}
\end{figure}
%%%%%%%%%%%%%%%
\clearpage
