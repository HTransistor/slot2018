...
\includegraphics[width=1.0\linewidth]{IMAGE/Versuch2Plot1horizontal2.pdf}
	\caption{Kontrast bei niedrigen $\frac{lp}{mm}$ in horizontaler Scanrichtung, wobei in der Legende \glqq III \grqq{} die Ausrichtung der Dunkellinien des USAF-Targets sind, woraus die Scanrichtung sich als horizontal erschließt.
