...
%\begin{figure}
%\subfloat[][]{\includegraphics[width=0.475\linewidth]{IMAGE/einkopplung.jpeg}%\label{fig:einkopplung}}
	%\caption{Einkopplung der Laserdiode}
%\qquad
%\subfloat[][]{\includegraphics[width=0.475\linewidth]{IMAGE/pmt.png}\label{fig:pmt}}
