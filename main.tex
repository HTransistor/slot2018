...
\includegraphics[width=1.0\linewidth]{IMAGE/Versuch2Plot1horizontal2.pdf}
	\caption{Kontrast bei geringen $\frac{lp}{mm}$ in horizontaler Scanrichtung, wobei in der Legende \glqq III \grqq{} die Ausrichtung der Dunkellinien des USAF-Targets sind, woraus die Scanrichtung sich als horizontal erschließt.
...
\includegraphics[width=1.0\linewidth]{IMAGE/Versuch2Plot1vertikal2.pdf}
	\caption{Kontrast bei geringen $\frac{lp}{mm}$ in vertikaler Scanrichtung.}
...
Bei geringen $\frac{lp}{mm}$ ist der Kontrast für eine höhere Wellenlänge höher.\\
...
\end{figure} 
Auch bei hohen $\frac{lp}{mm}$ verbessert ein erhöhter Strahlendurchmesser  den Kontrast. Zwar ist der Kontrast bei einer geringen $\left( lp/mm \right)$ bei einer höheren Wellenlänge höher, aber ab etwa $20 \frac{lp}{mm}$ erhöht eine kleine Wellenlänge den Kontrast.

Weiterhin sind die Modulationsübertragungsfunktionen für hohe $\frac{lp}{mm}$ in Abbildung \ref{fig:Versuch2_Plot2_all} dargestellt, um diese untereinander besser vergleichen zu können.
